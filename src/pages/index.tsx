  ...
  return (
    <>
      <h2 className="text-4xl">Welcome to  <span className="text-blue-500">Employee Tracker!!!</span></h2>
        <p className="text-2xl py-5">Employee Tracker is a powerful tool designed to help you manage your employee data efficiently. Whether you are a small business owner, a human resources manager, or simply looking to streamline your employee management process, Employee Tracker has you covered.</p>
